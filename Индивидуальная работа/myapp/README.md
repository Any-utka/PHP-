...
6) Нельзя добавить статью, если не вошел в систему

   ![Img-4](https://imgur.com/Be61wyC.png)
8) После входа переходим на страницу и видим приветствие

    ![Img-5](https://imgur.com/93uql6m.png)
10) В admin-панеле администратор может добавить/удалить пользователя, также удалить/отредактировать статью
