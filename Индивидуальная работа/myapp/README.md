...
4) Выходит предупрежнение, что для поиска статьи необходимо заполнить хотя бы одно поле

   ![Img-2](https://imgur.com/aXtcdFa.png) ![Img-3](https://imgur.com/KWn8FIA.png)
5) Нельзя добавить статью, если не вошел в систему

   ![Img-4](https://imgur.com/Be61wyC.png)
6) После входа переходим на страницу и видим приветствие

    ![Img-5](https://imgur.com/93uql6m.png)
7) В admin-панеле администратор может добавить/удалить пользователя, также удалить/отредактировать статью
...
8) Если зайти в профиль, как простой пользователь и нажать на кнопку для редактирования статьи, видим следующее
